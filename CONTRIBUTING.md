...
The following snippet describes luv-cli's repository structure.

```text
.
├── bin/
|   Source for luv-cli's binary. This links to the library defined in `lib/`.
│
├── lib/
|   Source for luv-cli's library. Contains luv-cli's core functionnalities.
│
├── test/
|   Unit tests and integration tests for luv-cli.
│
├── dune-project
